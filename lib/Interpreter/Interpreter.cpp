...
#include <vector>
     ...
     (defined(__clang__) ? !__has_feature(cxx_rtti) : !defined(__GXX_RTTI))
...
namespace cling {
  ...
  Interpreter::Interpreter(int argc, const char* const *argv,
    ...
    m_Opts(argc, argv), m_Parenting(nullptr), m_Commands(nullptr),
            ...
            if (!Scope) {
              ...
              if (!Name.empty()) {
                ...
                if (!parent())
                  ...
                  m_Executor->addSymbol(Name, &m_Parenting[0], true);
              }
            } else {
